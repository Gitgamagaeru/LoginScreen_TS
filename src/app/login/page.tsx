  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-900 font-sans p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md">
        ...
        {error && (
          <div className="mb-6 p-4 rounded-xl bg-red-50 dark:bg-red-500/10 text-red-600 dark:text-red-400 text-sm font-medium border border-red-200 dark:border-red-500/20 animate-fade-in-up">
        ...
        <div className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl rounded-3xl shadow-xl shadow-slate-200/50 dark:shadow-black/20 border border-white/50 dark:border-slate-700/50 p-8 sm:p-10 mb-8">
          {/* Email / Password Form */}
          <form className="space-y-5" action={loginWithCredentials}>
            <div>
              <label
                htmlFor="email"
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <div className="text-sm">
                  <a
                    href="#"
                    className="font-medium text-indigo-600 shadow-sm hover:text-indigo-500 dark:text-indigo-400 transition-colors"
                  >
                    お忘れですか？
                  </a>
                </div>
            ...
            <div className="flex items-center pb-2">
              ...
              <label
                htmlFor="remember-me"
                className="ml-2 flex-col text-sm text-slate-600 dark:text-slate-400 cursor-pointer"
              >
                ログイン状態を維持する
              </label>
            </div>
          ...
          <div className="mt-8">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-3 bg-white/80 dark:bg-slate-800 text-slate-500">
                  または
                </span>
              </div>
            </div>
            ...
            <div className="mt-6 grid grid-cols-2 gap-4">
              ...
              <form action={loginWithGoogle}>
                <button
                  type="submit"
                  className="flex items-center justify-center w-full px-4 py-3 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 text-sm font-medium transition-colors shadow-sm active:scale-95 duration-200"
                >
                  <svg
