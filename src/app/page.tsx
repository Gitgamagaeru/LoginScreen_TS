          ...
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <div className="flex-shrink-0 flex items-center">
                <div className="w-9 h-9 rounded-xl bg-gradient-to-tr from-indigo-600 to-purple-600 flex items-center justify-center text-white font-bold text-xl shadow-sm">
                  L
                </div>
                <span className="ml-3 font-semibold text-xl tracking-tight dark:text-white">
                  AppBoard
                </span>
              </div>
            </div>
            <div className="flex items-center space-x-5">
              ...
              <form action={handleSignOut}>
                <button
                  type="submit"
                  className="text-sm font-medium text-slate-500 hover:text-indigo-600 dark:text-slate-400 dark:hover:text-indigo-400 px-3 py-2 rounded-md hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors"
                >
                  ログアウト
                </button>
              </form>
